...
- Directional light cascades default to **1 cascade**.
...
- Disable *point light shadow casting* to reduce per-frame shadow pass cost and avoid hard, unfiltered point-shadow edges dominating the scene.
